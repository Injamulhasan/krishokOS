      ...
      <div className="mx-auto flex min-h-screen max-w-4xl flex-col justify-center px-6 py-16">
        <div className="rounded-[32px] border border-[#D9DFC8] dark:border-emerald-900/40 bg-white dark:bg-[#121c15] p-10 shadow-lg transition-colors duration-300">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link
              href="/auth/signin"
              className="rounded-[24px] border border-[#DCE8D8] dark:border-emerald-900/40 bg-[#F4F5ED] dark:bg-[#0b130c] px-6 py-6 text-center font-semibold transition hover:border-[#00963F] dark:hover:border-emerald-500 hover:text-[#00963F] dark:hover:text-emerald-400 text-[#1C2B1F] dark:text-[#e2ede4]"
            >
              Sign In
            </Link>
            <Link
              href="/auth/signup"
              className="rounded-[24px] bg-[#00963E] dark:bg-emerald-600 px-6 py-6 text-center font-semibold text-white transition hover:bg-[#007d2d] dark:hover:bg-emerald-700"
            >
              Sign Up
            </Link>
          </div>
